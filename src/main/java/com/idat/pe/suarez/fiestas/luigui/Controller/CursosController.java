package com.idat.pe.suarez.fiestas.luigui.Controller;
...
public class CursosController {
	...
	public class CursoController {
		...
		public ResponseEntity<Void> eliminar(@PathVariable Integer id) {
			...
			Cursos c =service.obtenerCursoId(id);
		...
		public ResponseEntity<Void> actualizar(@RequestBody Cursos cursos) {
			...
			Cursos c =service.obtenerCursoId(cursos.getIdCurso());
		...
		public ResponseEntity<Cursos> obtenerId(@PathVariable Integer id) {
			...
			if(c != null) {
				return  new ResponseEntity<Cursos>(service.obtenerCursoId(id),HttpStatus.OK);
